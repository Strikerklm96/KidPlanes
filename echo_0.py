...
# apply softmax (which basically just turns our guesses into more appropriate probability guess, (0.1, 0.4)->(0.2, 0.8) horray 10 (our base of numbers) is not a prime
